...
new_image.save('/home/jing/FIQA_repo/img_test/518_1.jpg')
img1 =cv2.imread('/home/jing/FIQA_repo/img_test/518_1.jpg')
...
new_image.save('/home/jing/FIQA_repo/img_test/518_2.jpg')
img1 =cv2.imread('/home/jing/FIQA_repo/img_test/518_2.jpg')
print('Image Width is',img1.shape[1])
print('Image Height is',img1.shape[0])
width3 = round(width * 1/4 )
height3 = round(height * 1/4)
new_image = image_file.resize((width3, height3))
new_image.save('/home/jing/FIQA_repo/img_test/518_3.jpg')
img1 =cv2.imread('/home/jing/FIQA_repo/img_test/518_3.jpg')
print('Image Width is',img1.shape[1])
print('Image Height is',img1.shape[0])